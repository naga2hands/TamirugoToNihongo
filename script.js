...
const stages = [
...

  {
    ...
    note: 'Keep the ஹ-series transformation and change the ஹு form to ஃபு for the final stage.',
    summary: 'நிலை-10: உச்சரிப்பு மாற்றம் (து -> ட்சு)',
  },

  {
    label: 'ன் எனுஞ்சிறப்பு ஓசை',
    note: 'Remove the ன vowel syllables and leave only the virama form ன் in that row.',
