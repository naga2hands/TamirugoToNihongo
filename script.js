...
const stages = [
...

  {
    ...
    இந்த 7 நெடில்களுக்கும் யப்பானிய மொழியில் தனி வரிவடிவம் இல்லை, இருக்கும் குறில்களின் வரிவடிவங்களைக் கொண்டே நெடில்களை வரவழைக்கும் எளிமையானதொரு நெடுங்கணக்கு முறையை கையாளுகின்றனர்.\n
    அதாவது, 'காகம்' என்பதை 'கஅகம்' என்று எழுதி, 'கஅ' என்பதை 'கா' என்றும், போலவே 'கை' என்பதை 'கஇ' என்றும் எழுதிப் படிப்பதைப்போன்றது, கால மாற்றத்தில் தமிழும் யப்பானியமும் வெவ்வேறு வழியை பின்பற்றியிருக்கின்றன. இது குறித்து பின்னர் விரிவாகப் பார்க்கலாம்.`,
...

  {
    ...
    கவனத்தில் கொள்ளுங்கள் நாம் நெடில்களின் வரிவடிவத்தைதான் இங்கிருந்து நீக்கியிருக்கிறோம். தமிழ் மொழி போலவே யப்பானிய மொழியிலும் நெடில்கள் இருக்கின்றன அவற்றை எழுதும் முறை சற்று வித்தியாசமானது. இது குறித்து பின்னர் விரிவாக பார்க்கலாம்.\n
...

  {
    ...
    <b>ங், ஞ்: </b>
    இந்த 'ங்' & 'ஞ்' வரிசையிலுள்ள எழுத்துகளை முதலாகக்கொண்டு எந்தவொரு சொல்லும் யப்பானிய மொழியில் இல்லை, சொல்லின் இடையில் மட்டுமே இவை வரும், அப்படி வருகையில் இவற்றை 'ன்' என்ற எழுத்து கொண்டே யப்பானியர்கள் எழுதுவர்.  தமிழிலும் கூட 'தங்கம்' என்பதை 'தன்கம்' என்றும், 'மஞ்சள்' என்பதை 'மன்சள்' என்றும் எழுதிப்படிக்க முடியும்.\n
    <b>ட், ண்: </b>
    இந்த 'ட்' & 'ண்' வரிசையிலுள்ள எந்த எழுத்துகளைக்கொண்டும் யப்பானிய மொழியில் சொற்களே இல்லை.\n
    <b>ல்: </b>
    யப்பானிய மொழியில் 'ல்' வரிசையின் ஒலியே இல்லை என்பர் சிலர், ஆனால் உண்மையில், 'l' என்பதும் 'ர' என்பதும் இணைந்த ஒரு ஒலி உள்ளது, அதை 'ர' வரிசையில் வைத்துள்ளனர், எனவே 'ல' எனும் தனி வரிசை கிடையாது.  "ராமென்" என்று யப்பானியர் உச்சரிக்கையில் உங்களுக்கு "லாமென்" என்று கேட்கும் காரணம் இதுவே.\n
    <b>ழ், ள் & ற்: </b>
    ஏற்கனவே 'ல' வரிசையும் 'ர' வரிசையும் இணைந்து 'ர' வரிசையாக இருப்பதால் இந்த 'ழ', 'ள' மற்றும் 'ற' வரிசைகள் யப்பானிய மொழியில் தேவையற்று போகிறது, ஏஎனெனில் யப்பானிய ஒலி அமைப்பு எளிமையானது.\n`,
  ...
  {
    label: 'ஃபு அல்லது ஹு',
    note: `ஒரு வல்லொலி (ப) மெல்லொலியாக (ஹ) மாறுவதற்கு இடையில் இடைநிலை ஒன்றை பெறலாம் அது உராய்வுஒலி எனப்படும். இதன்படி யப்பானிய 'ப' வரிசை 'ஹ' வர்சையாக மாறுவதர்கு முன்னர் 'ஃப' எனும் வரிசையாக மாறியிருக்கிறது.\n
    அதாவது "ஃப, ஃபி, ஃபு, ஃபெ, ஃபொ" என்று மாறியிருக்கிறது, இதிலிருந்து ஹ வரிசைக்கு மாறும்பொழுது "ஃபு" மட்டும் அப்படியே நிலைத்து நின்றவிட்டது என்றும் கொள்ளலாம். நன்கு கவனித்தீர்கள் என்றால், இந்த "ஃபு" ஆனது "ஹு" என்றும்கூட கேட்கும்.\n
    யப்பானியர் "ஃபுஜி" மலையின் பெயரை உச்சரிக்கையில் அது "ஹுஜி" என்றும் கேட்கலாம், அவ்வளவு மெல்லிய வித்தியாசம்தான் இருக்கிறது இரண்டு ஒலிக்கும்.\n
    ஒன்றை கவனித்தீர்களா? இந்த 'fu' எனும் ஒலியை நாம் எளிமையாக 'ப' முன் 'ஃ' என்ற ஆய்த எழுத்தைச் சேர்த்து வாசிக்கிறோம் ஆனால் தொல் தமிழ் இலக்கணப்படி இப்படி பயன்படுத்த இயலாது எனினும், தமிழ் அறிஞர்கள் வேற்று மொழி ஒலிகளை நாம் தனிஎழுத்து என்றும் அழைக்கப்படும் 'ஃ' கொண்டு உச்சரிக்க முடியும் என வழியிருத்தினர். குறிப்பாக இதுகுறித்து அறிஞர்கள் பா.வே. மாணிக்கனார் பல்வேறு முறைகளை முன்மொழிந்துள்ளார், அவற்றை நாம் முழுமையாக கையாளவில்லை என்றாலும் 'f' ஒலிக்கு நாம் உபயோகப்படுத்துவதைப் பார்க்கையில் காரணம் கருதிதான் தொல்தமிழில் "தனிஎழுத்து" என்று பெயரிட்டனரோ என்று தோன்றுகிறது`,
    summary: 'படிநிலை-12: உச்சரிப்பு மாற்றம் (ஃபு)',
  },

  {
    label: 'யியும் யெயும், இயும் எயுமாய் இருத்தல்',
    note: `"ய யி யு யெ யொ" எனும் வரிசையில் 'யி' யை 'இ' என்றும் 'யெ' வை 'எ' என்றும் உச்சரிக்கலாம் தானே, இந்த வெளிப்படையான காரணத்திற்காகவே யப்பானியர்கள் இந்த 'யி' மற்றும் 'யெ' வை 'ய' வரிசையிலிருந்து நீக்கியிருக்கின்றனர்.\n
    தமிழிலும் கூட,\n
...

  {
    ...
    note: `\n\n\nஇப்பொழுது 'அ' துவங்கி 'ய' வரிசை வரை வாசித்துப்பாருங்கள், முடிந்தால் ஒரு பாடல் போல கூட பாடிப்பருங்கள்`,
    summary: 'படிநிலை-14: யி மற்றும் யெ ஒலிகளின் மதிப்புகளை நீக்கு',
  },

  {
    label: 'வியும் வுவும் வெவும், இயும் உவும் எயுமாய் இருத்தல்',
    note: `"வ வி வு வெ வொ" எனும் வரிசையில் 'வு' வை 'உ' என்றும் உச்சரிக்கலாம் தானே, இந்த வெளிப்படையான காரணத்திற்காகவே யப்பானியர்கள் இந்த 'வு' வை 'வ' வரிசையிலிருந்து நீக்கியிருக்கின்றனர்.\n
    தமிழிலும் கூட,\n
    "கடவுள்" என்பதை "கடஉள்" என்றும்,
    "பரப்பளவு" என்பதை "பரப்பளஉ' என்றும் எழுதி வாசிக்க முடியும்.\n
    மேலும், 'வி', 'வெ' ஒலிகளைப்பொருத்தமட்டில், இவற்றில் பல நூற்றாண்டுகளுக்கு முன்னரே 'வ்' எனும் மெய்ஒலி நீங்கி 'இ' மற்றும் 'எ' என்ற மாற்றத்தை அடைந்துவிட்டது. பழைய யப்பானிய மொழியில் "விரு" என்பது, "இரு" என தற்போது மாற்றமடைந்திருக்கிறது, போலவே "வெ" என்பது, "எ" என மாற்றமடைந்திருக்கிறது.\n
...

  {
    ...
    note: `\n\n\nஇப்பொழுது 'அ' துவங்கி 'ன்' வரிசை வரை வாசித்துப்பாருங்கள், முடிந்தால் ஒரு பாடல் போல கூட பாடிப்பருங்கள்`,
...

  {
    ...
    தொல்காப்பியர் அகரம் முதல் னகரம் வரை 30 எழுத்துக்கள் என்கிறார், யப்பானிய மொழியிலோ அதே அகரம் முதல் னகரம் வரை 46 எழுத்துக்கள் எனலாம்\n
    நான் கையாண்ட இந்த முறையை வைத்து நான் தமிழிலிருந்து யப்பானிய மொழி பிறந்தது எனச்சொல்வதாய் கொள்ளாதீர்கள், அப்படி செய்யின் அது மொட்டைத்தலைக்கும் முலங்காலுக்கும் முடிச்சு போடுவது போல் ஆகிவிடும்\n
    எனினும் யப்பானிய மொழியை கற்கப்போய், தமிழ்மேல் மீண்டும் காதல் வந்து, பின் மொழிகளின் மீதே பொதுவாய் அன்பு கொண்டு பார்க்கையில் உலகின் எல்லா மொழிகளும் ஒன்றொன்றின் தொடர்ச்சியே என்பது புரிகிறது`,
